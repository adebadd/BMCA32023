...
public class DeleteStockPanel extends JPanel {
    ...
    public DeleteStockPanel(MainFrame mainFrame, ArrayList<Item> itemsList) {
        ...
        try {
              ...
              JButton btnDelete = new JButton("DELETE SELECTED STOCK");
              btnDelete.setForeground(new Color(0, 128, 255));
              btnDelete.setFont(new Font("Arial", Font.BOLD, 20));
              btnDelete.setBorder(new LineBorder(new Color(255, 255, 255), 2));
              btnDelete.setBackground(Color.WHITE);
              btnDelete.setActionCommand("Delete");
              btnDelete.setBounds(482, 19, 282, 43);
              panel.add(btnDelete);
              ...
              btnDelete.addActionListener(new ActionListener() {
                  public void actionPerformed(ActionEvent e) {
                      ...
                      if (selectedRow >= 0) {
                          int confirm = JOptionPane.showConfirmDialog(DeleteStockPanel.this, "Are you sure you want to delete the selected stock?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
                          if (confirm == JOptionPane.YES_OPTION) {
                              itemsList.remove(selectedRow);
                              refreshTable();
                          }
                      } else {
                          JOptionPane.showMessageDialog(DeleteStockPanel.this, "Please select an item to delete.", "No Selection", JOptionPane.WARNING_MESSAGE);
                      }
                  }
              });
